    ...
    render() {
        ...
        return (
            <div style={{
                ...
                <DoneIcon onDoneChange={(value) => this.handleDoneChange(value)} done={this.props.done}/>
                <ProgressIcon onProgressChange={(value) => this.handleProgressChange(value)} progress={this.props.progress} />
